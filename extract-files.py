...
# Keep this list tied to the liuqin OS3.0.7.0 blobs.  The rules below were
# selected by inspecting the affected liuqin files, not copied wholesale from
# another sm8450-family device.
